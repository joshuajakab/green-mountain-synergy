    ...
    return(
        <div className='blogs-container'>
            ...
            */}
            ...
            In the past five years things changed drastically and in 2018 the federal government passed the farm bill making growing hemp legal in all 50 states and essentially opened the floodgates on the CBD industry. At the same time amazing hemp genetics came out that were able to produce 20% CBD content which was unheard of 10 years ago. Many companies also cut corners in the drying and harvesting process using big mechanical harvesters and speed drying the hemp allowing massive acreage to be grown. This caused a huge influx of hemp to be grown which caused the price of hemp and CBD to crash in the past few years. With this crash you would expect the price of products to go down as well.
            This has not been the case as many companies were formed before this crash and were already charging what they were charging. This still exists to this day where many companies are charging exorbitant rates for their products. At Green Mountain Synergy we are basing our pricing on the current market value for hemp. We are also a direct to consumer company allowing us to sell our products directly to our customers, by cutting out the middleman we are able to pass those savings onto our customers.
            </div> 
            <br />
            <div className='blog-subtitle'>Quality</div>
            <div className='blog-content'> It is true that quality can differ greatly from one CBD product to another. This is because there are many different variables from plant quality, how it is dried, extraction technique, and what type of concentrate is used. 
            With so many different ways to grow hemp and so many different genetics available this is a big variable in the quality of the end product. Green Mountain Synergy only sources the highest quality hemp grown on Vermont organic farmland. We then slow dry the hemp to preserve its precious terpenes which are extremely volatile and destroyed by heat. 
