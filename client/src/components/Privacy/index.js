...
const Privacy = props => {
    return(
        <div className='privacy-container'>
            ...
            <p>Last updated: December 21, 2021</p><br />
            ...
            We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the Privacy Policy Template.</p>
            ...
            <p>     -Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Green Mountain Synergy LLC, 288 Stearns Rd Brandon VT 05733.</p>
            ...
            <p>     -Country refers to: Vermont, United States</p>
            ...
            <p>     -Website refers to Green Mountain Synergy, accessible from www.greenmountainsynergy.com</p>
            <p>You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p><br />
...
By email: greenmountainsynergy@gmail.com

By phone number: 8022823058</p>
        </div>
    )
};
